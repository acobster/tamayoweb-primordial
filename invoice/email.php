...
<head>
	...
	<style type="text/css" media="screen">
		...
		body { line-height: 1; }
		h1, h2, h3, h4, h5, h6 { font-family: Palatino; font-weight: normal; clear: both; }
		...
		body { line-height: 1; background-color:#FFF; font-size: 12px;}
		a img { border: none; }
		...
		fieldset legend {display:block; padding:0px 5px; color:#339944; font-size:13px; font-family: Palatino;}
		...
		.breakdown tr.heading td {color:#43AA43; text-transform:uppercase; font-size:14px; line-height:14px; padding:7px 5px; font-weight:bold; }
		...
		.breakdown tr.heading td.total {background-color:#339944; color:#FFF;}
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <td class="greeting">
        <p>
            ...
            <br>
            Please see your invoice below.<br>
            <br>
            Thank you,
	    <br>
		Coby Tamayo
    ...
    <td align="center">
        ...
        <td align="left" valign="top">
            ...
            <table cellpadding="0" cellspacing="0" class="header">
           	<tr>
            	<td><img src="<?php invoice_template_url(); ?>/images/logo.png" height="75" width="75"/></td>
		<td>
                    <h3>Tamayo Web Solutions</h3>
		    <br />
		    <hr />
                    <p id="contact" align="center">820 S Cushman Ave &middot; Tacoma, WA 98405 &middot; <a href="cobytamayo@gmail.com">cobytamayo@gmail.com</a> &middot; (253) 222 9139</p>
                    <hr />
			</td>
            </tr>
            </table>
            ...
            <table cellpadding="0" cellspacing="0" class="breakdown" style="margin:12px;">
            	<tr class="heading">
                	<td style="padding:12px;">Project Breakdown</td><td style="padding:12px;">Type</td><td style="padding:12px;">Rate</td><td style="padding:12px;">Hours</td><td style="width:75px;">Subtotal</td>
                </tr>
				<?php if(invoice_has_details()): ?>
                    <?php while(invoice_detail()): ?>
                            <tr class="title">
                                <td style="padding:12px;"><?php the_detail_title(); ?></td>
				<td style="padding:12px;"><?php the_detail_type(); ?></td>
				<td style="padding:12px;"><?php the_detail_rate(); ?></td>
				<td style="padding:12px;"><?php the_detail_duration(); ?></td>
				<td style="padding:12px;"><?php the_detail_subtotal(); ?></td>
                            </tr>
